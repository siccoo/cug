  ...
  const faq_list = [
    {
      ...
      paragraph: '•	MTN Police CUG Service is a special voice and data package that allows Police Officers communicate for free among themselves at a flat monthly rate; payable via their individual’s airtime. •	It is packaged to facilitate communication and collaboration among the Police.'
    },
    {
      id : 2,
    ...
    } ,  
    {
     ...
     {
      id : 8,
      title: 'How much monthly access fee will I be charged for the Police CUG Service? ',
     ...
     {
      id : 11,
      title: 'What happens when a subscriber does not renew monthly access fee?',
    ...
    {
      id : 13,
      title: 'Can unused CUG minutes, SMS or data be carried over to a new month??',
